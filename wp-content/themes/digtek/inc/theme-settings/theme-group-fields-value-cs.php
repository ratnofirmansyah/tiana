...
if (!class_exists('Digtek_Group_Fields_Value')) {

    class Digtek_Group_Fields_Value
    {
        ...
        public static function get_404_options_value()
        {
            ...
            in conversion', 'digtek');;
            $return_val['subtitle'] = cs_get_option('404_subtitle') ? cs_get_option('404_subtitle') : esc_html__('Oops! That page can&rsquo;t be found.', 'digtek');;
            $return_val['paragraph'] = cs_get_option('404_paragraph') ? cs_get_option('404_paragraph') : esc_html__('It looks like nothing was found at this location. Maybe try one of the links below or a search?', 'digtek');
            $return_val['btn_text'] = cs_get_option('404_button_text') ? cs_get_option('404_button_text') : esc_html__('Back To Home', 'digtek');
