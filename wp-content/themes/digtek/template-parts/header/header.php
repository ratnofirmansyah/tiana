            ...
            <div class="header-main">
                <div class="logo">
                    <?php                               
                        if (has_custom_logo() && empty($header_default_logo['id'])) {
                            ...
                            printf('<a class="header-logo-3" href="%1$s"><img src="%2$s" alt="%3$s"/></a>', esc_url(get_home_url()), $header_default_logo['url'], $header_default_logo['alt']);
                        } else {
                ...
                <div class="header-right d-flex justify-content-end align-items-center">
                    ...
                    <div class="main-button">
                        <a href="<?php echo esc_url( $header_default_right_btn_url ); ?>">
                            <span class="theme-btn"> <?php echo esc_html( $header_default_right_btn_text ); ?></span>
