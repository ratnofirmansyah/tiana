...
class Digtek_Recent_Post_Widget extends WP_Widget

{
    public function __construct()
    {
        parent::__construct(
            'digtek_popular_posts',
            esc_html__('Digtek: Recent Posts with Thumbnails', 'digtek-core'),
...
if (!function_exists('Digtek_Recent_Post_Widget')) {

    function Digtek_Recent_Post_Widget()

    {
        register_widget('Digtek_Recent_Post_Widget');
    }

    add_action('widgets_init', 'Digtek_Recent_Post_Widget');
