    ...
    class Digtek_Init
    {
        ...
        */
        ...
        public function theme_setup()
        {
             ...
             */
            load_theme_textdomain('digtek', get_template_directory() . '/languages');
            ...
            register_nav_menus(array(
                'main-menu' => esc_html__('Primary Menu', 'digtek'),
                'main-menu-2' => esc_html__('Primary Menu Two', 'digtek'),
                'category-menu' => esc_html__('Category Menu', 'digtek'),
                'footer-menu' => esc_html__('Footer Menu', 'digtek'),
            ));
            ...
            $GLOBALS['content_width'] = apply_filters('digtek_content_width', 740);

            //add image sizes
            add_image_size('digtek_classic', 750, 400, true);
            add_image_size('digtek_grid', 370, 270, true);
            add_image_size('digtek_medium', 550, 380, true);
            add_image_size('digtek-team-slider-one', 450, 460, true);
            add_image_size('digtek-team-classic', 550, 530, true);
        ...
        public function theme_widgets_init()
        {
            register_sidebar(array(
                'name' => esc_html__('Sidebar', 'digtek'),
                'id' => 'sidebar-1',
                'description' => esc_html__('Add widgets here.', 'digtek'),
            ...
            register_sidebar(array(
                'name' => esc_html__('Footer Menu Widget', 'digtek'),
                'id' => 'footer-widget',
                'description' => esc_html__('Add widgets here.', 'digtek'),
            ...
            register_sidebar(array(
                'name' => esc_html__('Footer Menu Widget Two', 'digtek'),
       ...
       */
        ...
        public static function load_google_fonts() {
            ...
            $body_font['family'] = isset($body_font['font-family']) && !empty($body_font['font-family']) ? $body_font['font-family'] : 'Plus Jakarta Sans';
            ...
            $heading_font['family'] = isset($heading_font['font-family']) && !empty($heading_font['font-family']) ? $heading_font['font-family'] : 'Plus Jakarta Sans';
        ...
        {
            $theme_version = DIGTEK_DEV ? time() : digtek()->get_theme_info('version');
            $css_ext = '.css';
            // load google fonts
            $enqueue_google_fonts = self::load_google_fonts();
            if (!empty($enqueue_google_fonts)) {
                wp_enqueue_style('digtek-google-fonts', esc_url(add_query_arg('family', urlencode(implode('|', $enqueue_google_fonts)), '//fonts.googleapis.com/css')), array(), null);
            }
            $all_css_files = array(
                array(
                    'handle' => 'bootstrap',
                    'src' => DIGTEK_CSS . '/bootstrap.min.css',
                    'deps' => array(),
                    'ver' => $theme_version,
                    'media' => 'all',
                ),
                ...
                array(
                    ...
                    'src' => DIGTEK_CSS . '/magnific-popup.css',
                    'deps' => array(),
                    'ver' => $theme_version,
                    'media' => 'all',
                ),
                array(
                    'handle' => 'meanmenu',
                    'src' => DIGTEK_CSS . '/meanmenu' . $css_ext,
                    'deps' => array(),
                    'ver' => $theme_version,
                    'media' => 'all',
                ),
                array(
                    'handle' => 'nice-select',
                    'src' => DIGTEK_CSS . '/nice-select' . $css_ext,
                    'deps' => array(),
                    'ver' => $theme_version,
                    'media' => 'all',
                ),
                array(
                    ...
                    'src' => DIGTEK_CSS . '/swiper-bundle.min' . $css_ext,
                    'deps' => array(),
                    'ver' => $theme_version,
                    'media' => 'all',
                ),  
                ...
                array(
                    'handle' => 'digtek-main-style',
                    'src' => DIGTEK_CSS . '/main' . $css_ext,
                    'deps' => array(),
                    'ver' => $theme_version,
                    'media' => 'all',
                ),   
            ...
            $all_css_files = apply_filters('digtek_theme_enqueue_style', $all_css_files);
            ...
            wp_enqueue_style('digtek-style', get_stylesheet_uri());

            if (digtek()->is_digtek_core_active()) {
                if (file_exists(DIGTEK_DYNAMIC_STYLESHEETS . '/theme-inline-css-style.php')) {
                    require_once DIGTEK_DYNAMIC_STYLESHEETS . '/theme-inline-css-style.php';
                    require_once DIGTEK_DYNAMIC_STYLESHEETS . '/theme-option-css-style.php';
                    wp_add_inline_style('digtek-style', digtek()->minify_css_lines($GLOBALS['digtek_inline_css']));
                    wp_add_inline_style('digtek-style', digtek()->minify_css_lines($GLOBALS['theme_customize_css']));
                }
        ...
        public function load_theme_js()
        {
            ...
            wp_enqueue_script( 'digtek-main-script', get_template_directory_uri() . '/assets/js/main.js', array('jquery'), time(), true );
        ...
        public function load_theme_dependency_files()
        {
            $includes_files = array(
                array(
                    ...
                    'file-path' => DIGTEK_TGMA
                ),
                array(
                    'file-name' => 'theme-breadcrumb',
                    'file-path' => DIGTEK_INC
                ),
                array(
                ...
                array(
                    ...
                    'file-path' => DIGTEK_THEME_SETTINGS
                ),
                array(
