...
class Theme_Accordion extends Widget_Base {
	...
	public function get_name() {
		return 'digtek-theme-accordion-widget';
	}
	...
	public function get_title() {
		return esc_html__( 'Theme Accordion', 'digtek-core' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'content_section',
			[
				'label' => __( 'Accordion Repeater', 'digtek-core' ),
				...
				<div class="accordion" id="accordion">
					...
					<div class="accordion-item mb-3 wow fadeInUp" data-wow-delay=".5s">
						<h5 class="accordion-header">
							<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq2<?php echo esc_attr($key);?>" aria-expanded="false" aria-controls="faq2<?php echo esc_attr($key);?>">
								<?php echo wp_kses($item['block_title'], $allowed_tags);?>
							</button>
						</h5>
						<div id="faq2<?php echo esc_attr($key);?>" class="accordion-collapse collapse <?php if($key == 1) echo 'show';?>" data-bs-parent="#accordion">
