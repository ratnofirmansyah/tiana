...
$page_layout_meta = Digtek_Group_Fields_Value::page_layout('digtek');
$page_container_meta = Digtek_Group_Fields_Value::page_container('digtek','container_options');
...
if ('blank' == $page_layout_meta['layout']):
	...
	?>
    <div id="primary" class="content-area digtek-page-content-area padding-120 page-content-wrap-<?php the_ID(); ?> <?php echo esc_attr($full_width_class);?>">
