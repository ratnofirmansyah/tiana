...
class Digtek_Breadcrumb {
	/**
	 * Array of bread Digtek_Breadcrumb
	 *
	 * @var array
	 */
	...
	public function __construct( array $options = [] ) {
		...
		$this->defaults['home'] = esc_html__('Home','digtek');
		$this->defaults['blog'] = esc_html__('Blog','digtek');
	...
	public function theBreadcrumbs() {
		...
		foreach ( $breadcrumbs as $crumb ) {
			...
			if ( $crumb['url'] ) {
                ...
                $html .= sprintf( '<span>%s</span>', wp_kses($crumb['title'],digtek()->kses_allowed_html('all')) );
			}
		...
		echo wp_kses($html,digtek()->kses_allowed_html('all'));
	}
	...
	public function getBreadcrumbs() {
		...
		$breadcrumbs = apply_filters( 'digtek_get_breadcrumbs', $breadcrumbs );
 ...
 * Template Functions.
 */
if ( ! function_exists( 'digtek_breadcrumb' ) ) {
	/**
	 ...
	 * @package digtek
	 */
	function digtek_breadcrumb( $options = [] ) {
		$Crumbs = new Digtek_Breadcrumb( $options );
		$Crumbs->theBreadcrumbs();
	}
}

if ( ! function_exists( 'digtek_get_breadcrumbs' ) ) {
	/**
	 ...
	 * @return array
	 */
	function digtek_get_breadcrumbs( $options = [] ) {
		$Crumbs = new Digtek_Breadcrumb( $options );
 ...
 * Utility functions
 */
if ( ! function_exists( 'digtek_breadcrumb_array_insert' ) ) {
	/**
	 ...
	 * @return array
	 */
	function digtek_breadcrumb_array_insert( array $array, $element, int $position ) {
